...
impl candle::CustomOp1 for FlashInferAppend {
    ...
    fn cuda_fwd(
        ...
        unsafe {
            candle_vllm_kernels::ffi::flashinfer_append_kv_cache(
                kc_ptr,
                vc_ptr,
                k_append_ptr,
                v_append_ptr,
...
impl FlashInferDecodeWithPlan {
    ...
    >(
        ...
        unsafe {
            candle_vllm_kernels::ffi::flashinfer_decode_run_wrapper(
                out_ptr,
                q_ptr,
                kc_ptr,
                vc_ptr,
...
pub fn decode_plan(
    ...
    unsafe {
        candle_vllm_kernels::ffi::flashinfer_decode_plan_wrapper(
...
impl FlashInferPrefill {
    ...
    >(
        ...
        unsafe {
            candle_vllm_kernels::ffi::flashinfer_prefill_wrapper(
                out_ptr,
                q_ptr,
...
impl FlashInferRaggedPrefill {
    ...
    >(
        ...
        let (ws_float_ptr, ws_int_ptr, page_locked_ptr, page_locked_size) =
            get_or_init_workspace(dev, false)?;
        unsafe {
            candle_vllm_kernels::ffi::flashinfer_prefill_ragged_wrapper(
                out_ptr,
                q_ptr,
                *q_lens_ptr.device_ptr() as *const i32,
