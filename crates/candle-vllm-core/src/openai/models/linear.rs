...
impl Module for LnFp8 {
    fn forward(&self, x: &Tensor) -> Result<Tensor> {
        ...
        // FP8 matmul requires attention-rs with fp8_linear support.
        // When available (cutlass feature), use the optimized path.
        #[cfg(feature = "cutlass")]
        ...
        #[cfg(not(feature = "cutlass"))]
        let out = {
            // FP8 models require the cutlass feature for fp8_linear support
            candle_core::bail!(
